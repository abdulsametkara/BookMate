...
struct ReadingStatistics: Codable, Equatable {
    ...
    static func == (lhs: ReadingStatistics, rhs: ReadingStatistics) -> Bool {
        return lhs.totalBooksRead == rhs.totalBooksRead &&
               lhs.booksReadThisYear == rhs.booksReadThisYear &&
               lhs.totalPagesRead == rhs.totalPagesRead &&
               lhs.readingStreak == rhs.readingStreak
    }
}